...
void UpdateDisplay() {
  if (PageNumber == 0) {        //MainPage
    if (MainPageNumber == 0) {  //MedicalMode
      ...
      MeterMode();
    } else if (MainPageNumber == 2) {  //DosimeterMode
      DosimeterMode();
      ...
      if (TouchDetected == false) {
        ...
        if (PageNumber == 0) {        //MainPage same as UpdateDisplay()
          ...
          if (SettingsPage == 0) {
            ...
            if ((TX > 3) && (TX < (3 + 234 + 80))) {  //Cal Touch Button
              if ((TY > 214) && (TY <= (214 + 44))) {
            ...
            if ((TX > 3) && (TX < (3 + 234 + 80))) {  //Time/Date Button
              if ((TY > 164) && (TY <= (164 + 44))) {
            ...
            if ((TX > 3) && (TX < (3 + 234 + 80))) {  //BT Speed Button
              if ((TY > 164) && (TY <= (164 + 44))) {

                Serial.println("BT Speed Button pressed");
            ...
            if ((TX > 3) && (TX < (3 + 234 + 80))) {  //BT Log Button
              if ((TY > 214) && (TY <= (214 + 44))) {

                Serial.println("BT Log Button pressed");
            ...
            if ((TX > 3) && (TX < (3 + 234 + 80))) {  //Update Button
              if ((TY > 114) && (TY <= (114 + 44))) {
            ...
            if ((TX > 3) && (TX < (3 + 234 + 80))) {  //Factory settings Button
              if ((TY > 164) && (TY <= (164 + 44))) {
...
void DrawBootPage() {
  ...
  //Wenn Logos vorhanden unters benutzen

  //tft.drawBitmap(61, 200, IMHSDLogoSmall, 195, 50, WHITE); //IMHSD LOGO

  //tft.drawBitmap(40, 270, MDCLogoSmall, 240, 50, WHITE);  //MDC LOGO

  //tft.drawBitmap(40, 340, GleasernesLaborLogoSmall, 240, 50, WHITE);  //GleasernesLabor LOGO
...
void TimedCountSettingsPage(int page) {
  ...
  if (page == 0) {
    ...
    tft.fillRoundRect(3, 23, 314, 35, 3, MENUBUTTONCOLOR);
    tft.setTextDatum(MC_DATUM);
    tft.setFreeFont(&FreeSans12pt7b);  //9,12,18,24pt
    tft.setTextSize(1);
    tft.setTextColor(WHITE);
  ...
  if (page == 0) {
    ...
    */
    ...
    if (Language == 0) {  //German
      ...
      tft.println("BT Geschwindigkeit");
    } else if (Language == 1) {  //English
      tft.setCursor(67 + 40, 195);
      tft.println("BT speed");
    }
    ...
    if (BTLog == true) {
      ...
      if (Language == 0) { //German
        tft.setCursor(59 + 40, 245);
        tft.println("BT Log aus");
      } else if (Language == 1) { //English
        tft.setCursor(62 + 40, 245);
        tft.println("BT log off");
      }
    } else {
      tft.fillRoundRect(3, 214, 314, 44, 4, DKGREEN);
      tft.drawRoundRect(3, 214, 314, 44, 4, WHITE);
      tft.setTextDatum(MC_DATUM);
      tft.setFreeFont(&FreeSans12pt7b); //9,12,18,24pt
      tft.setTextSize(1);
      ...
      if (Language == 0) { //German
        tft.setCursor(65 + 40, 245);
        tft.println("BT Log an");
      } else if (Language == 1) { //English
        tft.setCursor(65 + 40, 245);
        tft.println("BT log on");
      }
    }
    ...
    */
    ...
    if (Language == 0) { //German
      tft.setCursor(49 + 40, 145);
      tft.println("Langsam (2s)");
    } else if (Language == 1) { //English
      tft.setCursor(69 + 40, 145);
      tft.println("Slow (2s)");
    }
    ...
    */
    ...
    if (Language == 0) {  //German
      tft.setCursor(48 + 40, 195);
      tft.println("Schnell (0.5s)");
    } else if (Language == 1) {  //English
      tft.setCursor(63 + 40, 195);
      tft.println("Fast (0.5s)");
    }
    ...
    tft.fillRoundRect(3, 63, 314, 95, 4, DKGREY);
    tft.drawRoundRect(3, 63, 314, 95, 4, WHITE);
    ...
    if (Language == 0) {  //German
      tft.setCursor(10, 87);
      tft.print("BT Version: ");
    } else if (Language == 1) {  //English
      tft.setCursor(10, 87);
      tft.print("BT version: ");
    }
    //tft.println(BTVersion);
    ...
    */
    ...
    tft.fillRoundRect(3, 63, 314, 178 + 20, 4, DKGREY);
    tft.drawRoundRect(3, 63, 314, 178 + 20, 4, WHITE);
    ...
    tft.setCursor(10, 167);
    tft.print("CPU: ESP32 16MB");
    tft.setCursor(10, 187);
    tft.print("VBAT: 2600mAh");
    tft.setCursor(10, 207);
    tft.print("Disp: 320x480px");
...
void TouchCalApprovalPage() {
  ...
  if (Language == 0) {  //German
    tft.setCursor(0, 108);
    tft.print("Eine falsche Kalibrierung kann zur Unbrauchbarkeit des Gereates fuehren!");
  } else if (Language == 1) {  //English
    tft.setCursor(0, 108);
    tft.print("Incorrect calibration can lead to the device becoming unusable!");
  }
