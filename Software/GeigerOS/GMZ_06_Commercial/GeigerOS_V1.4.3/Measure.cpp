...
unsigned int InternCurrentCount;
unsigned int InternCumulativeCount;
unsigned int ExternCurrentCount;
unsigned int ExternCumulativeCount;
...
unsigned int FastCount[6];  //Arrays to store running counts
unsigned int SlowCount[181];
